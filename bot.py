...
# Temporary user states for multi-step dialogs
USER_STATES = {}
...
def handle_contact(message):
    ...
    # For teachers: Select their name from school teacher list
...
# --- TEACHER SELECTION & APPROVAL CALLBACKS ---
...
# --- DAY LESSON EDITING (O'QITUVCHI / ADMIN DARSNI TO'G'IRLASHI) ---
...
def process_day_edit_text(message):
    ...
    # Expected format: "2-dars 5A" or "4 7B"
    import re
...
# Fallback text handler for broadcast
...
if __name__ == "__main__":
    print("Ustoz AI Telegram Boti ishga tushdi...")
    print(f"Bosh Admin raqami: {config.ADMIN_PHONES}")
    try:
